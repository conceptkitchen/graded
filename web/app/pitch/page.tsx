      ...
      <div className="flex flex-col items-center justify-center h-full px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 gap-3 max-w-2xl w-full mb-4">
          <div className="border border-green-800 rounded-xl p-3 bg-green-950/20">
            ...
            <div className="text-2xl font-bold text-white">222+</div>
        ...
        <div className="mt-4 px-4 py-4 border border-green-800/50 rounded-lg bg-green-950/10 max-w-2xl">
          ...
          <div className="grid grid-cols-3 gap-3 text-center text-xs">
            <div>
              ...
              <div className="text-zinc-500">120 hand-built + 102 open source. 9 attack categories.</div>
            </div>
            <div>
    ...
    content: (
      <div className="flex flex-col items-center justify-center h-full px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl w-full mb-8">
          ...
          <div className="border border-zinc-700 rounded-xl p-4 bg-zinc-900/50 text-center">
            <div className="text-3xl font-black text-purple-400 mb-1">222+</div>
    ...
    content: (
      <div className="flex flex-col items-center justify-center h-full text-center px-6">
        ...
        <div className="max-w-lg space-y-3 text-base text-zinc-400 mb-10">
          ...
          <p>Open source engine. 222+ attack patterns. Multi-model deep scan via <span className="text-purple-400">Kalibr</span>.</p>
        </div>
